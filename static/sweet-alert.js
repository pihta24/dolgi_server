...
<html lang="en" style="height: 100%">
    <head>
        ...
        <script type="text/javascript">
            var Anywhere = {};
            Anywhere.urls = {};
            Anywhere.csrfToken = "FQoaunwCjwLdy3h7lUd01Ls6DP4PFb3xg4DOElJCfpsIn3ekPRo7BA7vZBJ6I0bg";
        </script>
...
<li class="visible-xs"><a href="https://blog.pythonanywhere.com/" class="blog_link">Blog</a></li>
  ...
  <form class="form" action="" method="post"><input type='hidden' name='csrfmiddlewaretoken' value='FQoaunwCjwLdy3h7lUd01Ls6DP4PFb3xg4DOElJCfpsIn3ekPRo7BA7vZBJ6I0bg' />
    <table>
